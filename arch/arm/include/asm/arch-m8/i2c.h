...
#define MESON_I2C_MASTER_A_GPIOZ_11_REG		CBUS_REG_ADDR(PERIPHS_PIN_MUX_5)
#define MESON_I2C_MASTER_A_GPIOZ_11_BIT		(1<<7)
#define MESON_I2C_MASTER_A_GPIOZ_12_REG		CBUS_REG_ADDR(PERIPHS_PIN_MUX_5)
#define MESON_I2C_MASTER_A_GPIOZ_12_BIT		(1<<6)
...
#define MESON_I2C_MASTER_B_GPIOZ_2_REG		CBUS_REG_ADDR(PERIPHS_PIN_MUX_5)
#define MESON_I2C_MASTER_B_GPIOZ_2_BIT		(1<<27)
#define MESON_I2C_MASTER_B_GPIOZ_3_REG		CBUS_REG_ADDR(PERIPHS_PIN_MUX_5)
#define MESON_I2C_MASTER_B_GPIOZ_3_BIT		(1<<26)
