...
//*****************************************
#define MODEL_NAME			"HSD043I9W1"	/** lcd model name */
...
#define ACITVE_AREA_HEIGHT	54	/** lcd active_area or display_area vertical size(unit in mm, you can find it on the home page of lcd spec) */
...
#define H_ACTIVE			480		/** horizontal resolution */
#define V_ACTIVE			272		/** vertical resolution */
#define H_PERIOD			620	/** horizontal period(htotal) */
#define V_PERIOD			310		/** vertical period(vtotal) */

#define	LCD_CLK				11500000/** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
#define CLK_POL				0	/** clk_polarity(only valid for TTL) */
#define HS_WIDTH			5	/** hsync_width */
#define HS_BACK_PORCH		40	/** hsync_backporch(include hsync_width) */
