...
//*****************************************
#define MODEL_NAME			"M215HTN01"	/** lcd model name */

#define ACITVE_AREA_WIDTH	477	/** lcd active_area or display_area horizontal size(unit in mm, you can find it on the home page of lcd spec) */
#define ACITVE_AREA_HEIGHT	268	/** lcd active_area or display_area vertical size(unit in mm, you can find it on the home page of lcd spec) */
...
#define V_ACTIVE			1080		/** vertical resolution */
#define H_PERIOD			2100	/** horizontal period(htotal) */
#define V_PERIOD			1130		/** vertical period(vtotal) */

#define	LCD_CLK				142400000	/** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
#define CLK_POL				1	/** clk_polarity(only valid for TTL) */
#define HS_WIDTH			50	/** hsync_width */
