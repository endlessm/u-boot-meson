...
//*****************************************
#define MODEL_NAME            "LM270WQ1_SDA2" /** lcd model name */

#define ACITVE_AREA_WIDTH     597 /** lcd active_area or display_area horizontal size(unit in mm, you can find it on the home page of lcd spec) */
#define ACITVE_AREA_HEIGHT    336 /** lcd active_area or display_area vertical size(unit in mm, you can find it on the home page of lcd spec) */
...
#define H_ACTIVE              2560 /** horizontal resolution */
#define V_ACTIVE              1440 /** vertical resolution */
#define H_PERIOD              2720 /** horizontal period(htotal) */
#define V_PERIOD              1481 /** vertical period(vtotal) */

#define	LCD_CLK               245500000 /** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
...
#define VS_BACK_PORCH         38 /** vsync_backporch(include vsync_width) */
