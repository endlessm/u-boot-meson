...
// TTL bridge to miniLVDS
//*****************************************
#define MODEL_NAME			"TM080XSZ00"	/** lcd model name */

#define ACITVE_AREA_WIDTH	174	/** lcd active_area or display_area horizontal size(unit in mm, you can find it on the home page of lcd spec) */
#define ACITVE_AREA_HEIGHT	104	/** lcd active_area or display_area vertical size(unit in mm, you can find it on the home page of lcd spec) */
#define LCD_TYPE			LCD_DIGITAL_MINILVDS   /** lcd interface(LCD_DIGITAL_MIPI, LCD_DIGITAL_LVDS, LCD_DIGITAL_EDP, LCD_DIGITAL_TTL) */
...
#define H_PERIOD			1440	/** horizontal period(htotal) */
#define V_PERIOD			810		/** vertical period(vtotal) */

#define	LCD_CLK				70000000	/** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
