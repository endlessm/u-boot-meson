...
//*****************************************
#define MODEL_NAME			"N070ICN"	/** lcd model name */
...
#define	LCD_CLK				56800000	/** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
#define CLK_POL				0			/** clk_polarity(only valid for TTL) */
#define HS_WIDTH			4	/** hsync_width */
