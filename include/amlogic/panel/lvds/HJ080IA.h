...
//*****************************************
#define MODEL_NAME			"HJ080IA"	/** lcd model name */

#define ACITVE_AREA_WIDTH	162	/** lcd active_area or display_area horizontal size(unit in mm, you can find it on the home page of lcd spec) */
#define ACITVE_AREA_HEIGHT	122	/** lcd active_area or display_area vertical size(unit in mm, you can find it on the home page of lcd spec) */
...
#define	LCD_CLK				65000000	/** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
