...
//*****************************************
#define MODEL_NAME			"CLAA070WP03"	/** lcd model name */
...
#define H_PERIOD			1000	/** horizontal period(htotal) */
#define V_PERIOD			1320	/** vertical period(vtotal)*/

#define	LCD_CLK				79200000	/** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
