...
//*****************************************
#define MODEL_NAME			"LP097X02"	/** lcd model name */
...
#define H_PERIOD			2084	/** horizontal period(htotal) */
#define V_PERIOD			810		/** vertical period(vtotal) */

#define	LCD_CLK				85700000	/** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
