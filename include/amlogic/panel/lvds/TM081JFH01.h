...
//*****************************************
#define MODEL_NAME			"TM081JFH01"	/** lcd model name */

#define ACITVE_AREA_WIDTH	109	/** lcd active_area or display_area horizontal size(unit in mm, you can find it on the home page of lcd spec) */
...
#define V_PERIOD			1320	/** vertical period(vtotal) */

#define	LCD_CLK				63400000	/** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
