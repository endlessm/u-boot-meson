...
//*****************************************
#define MODEL_NAME			"KD101N7"	/** lcd model name */
...
#define ACITVE_AREA_HEIGHT	125	/** lcd active_area or display_area vertical size(unit in mm, you can find it on the home page of lcd spec) */
