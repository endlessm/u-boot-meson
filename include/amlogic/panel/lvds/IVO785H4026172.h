...
//*****************************************
//Notice: this panel requeired twice reset when power on
//*****************************************
#define MODEL_NAME			"IVO785H4026172"	/** lcd model name */

#define ACITVE_AREA_WIDTH	120	/** lcd active_area or display_area horizontal size(unit in mm, you can find it on the home page of lcd spec) */
#define ACITVE_AREA_HEIGHT	160	/** lcd active_area or display_area vertical size(unit in mm, you can find it on the home page of lcd spec) */
...
#define H_PERIOD			928	/** horizontal period(htotal) */
#define V_PERIOD			1065		/** vertical period(vtotal) */

#define	LCD_CLK				59300000	/** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
