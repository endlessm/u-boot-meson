...
//*****************************************
#define MODEL_NAME			"HSD101PWW1"	/** lcd model name */

#define ACITVE_AREA_WIDTH	217	/** lcd active_area or display_area horizontal size(unit in mm, you can find it on the home page of lcd spec) */
#define ACITVE_AREA_HEIGHT	136	/** lcd active_area or display_area vertical size(unit in mm, you can find it on the home page of lcd spec) */
...
#define V_PERIOD			835		/** vertical period(vtotal) */

#define	LCD_CLK				71100000	/** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
