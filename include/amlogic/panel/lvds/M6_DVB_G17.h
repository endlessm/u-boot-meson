...
//*****************************************
#define MODEL_NAME			"M6_DVB_G17"	/** lcd model name */
...
#define H_PERIOD			864		/** horizontal period(htotal) */
#define V_PERIOD			1300	/** vertical period(vtotal) */

#define	LCD_CLK				66900000	/** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
