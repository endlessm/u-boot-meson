...
static int do_checkhw(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
	...
	switch(ddr_size){
		case 0x80000000 : /*2G DDR*/
			//printf("2G DDR platform\n");
			setenv("aml_dt", "m8_mango_2g");
			break;
		case 0x40000000 : /*1G DDR*/
			//printf("1G DDR platform\n");
			setenv("aml_dt", "m8_mango_1g");
			break;
		default :
			break;
	}
...
U_BOOT_CMD(
		...
		"Get the hardware revision","[<string>]\n"
);
