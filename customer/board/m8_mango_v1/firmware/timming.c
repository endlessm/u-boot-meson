...
{
	//GPIOY_4(PinE2): ddr size, 0:1GB, 1:2GB. CBUS:0x2011[4]
	serial_puts("Set DDR capacity to ");
	unsigned int ddr_size;
	ddr_size = (readl(P_PREG_PAD_GPIO1_I) >> 4) & 0x1;
	if(IS_MESON_M8M2_CPU){/*m8m2*/
		switch(ddr_size){
			case 1 : /*2G DDR*/
				...
				serial_puts("2GB. M8M2\n");
				break;
			case 0 : /*1G DDR*/
				__ddr_setting.phy_memory_size = 0x40000000;
				__ddr_setting.t_pub0_dtar = ((0x0 + CONFIG_M8M2_DDR0_DTAR_DTCOL)| \
					((M8M2_DDR_DTAR_DTROW_GET(CONFIG_DDR0_DTAR_ADDR,14,CONFIG_DDR0_COL_BITS,CONFIG_DDR_BANK_SET,CONFIG_DDR_CHANNEL_SWITCH,CONFIG_DDR_BIT_MODE)) <<12)| \
					((M8M2_DDR_DTAR_BANK_GET(CONFIG_DDR0_DTAR_ADDR,14,CONFIG_DDR0_COL_BITS,CONFIG_DDR_BANK_SET,CONFIG_DDR_CHANNEL_SWITCH,CONFIG_DDR_BIT_MODE)) << 28));
				__ddr_setting.t_pub1_dtar = ((0x0 + CONFIG_M8M2_DDR1_DTAR_DTCOL)| \
					((M8M2_DDR_DTAR_DTROW_GET(CONFIG_DDR1_DTAR_ADDR,14,CONFIG_DDR1_COL_BITS,CONFIG_DDR_BANK_SET,CONFIG_DDR_CHANNEL_SWITCH,CONFIG_DDR_BIT_MODE)) <<12)| \
					((M8M2_DDR_DTAR_BANK_GET(CONFIG_DDR1_DTAR_ADDR,14,CONFIG_DDR1_COL_BITS,CONFIG_DDR_BANK_SET,CONFIG_DDR_CHANNEL_SWITCH,CONFIG_DDR_BIT_MODE)) << 28));
				__ddr_setting.t_mmc_ddr_ctrl = (__ddr_setting.t_mmc_ddr_ctrl & 0xfffff3f3) | (2<<10) | (2<<2);
				serial_puts("1GB. M8M2\n");
				break;
			default :
				break;
		}
		...
		switch(ddr_size){
			case 1 : /*2G DDR*/
				__ddr_setting.phy_memory_size = 0x80000000;
				__ddr_setting.t_pub0_dtar = ((0x0 + CONFIG_M8_DDR0_DTAR_DTCOL)| \
					((M8_DDR_DTAR_DTROW_GET(CONFIG_DDR0_DTAR_ADDR,15,CONFIG_DDR0_COL_BITS,CONFIG_DDR_BANK_SET,CONFIG_DDR_CHANNEL_SET)) <<12)| \
					((M8_DDR_DTAR_BANK_GET(CONFIG_DDR0_DTAR_ADDR,15,CONFIG_DDR0_COL_BITS,CONFIG_DDR_BANK_SET,CONFIG_DDR_CHANNEL_SET)) << 28));
				__ddr_setting.t_pub1_dtar = ((0x0 + CONFIG_M8_DDR1_DTAR_DTCOL)| \
					((M8_DDR_DTAR_DTROW_GET(CONFIG_DDR1_DTAR_ADDR,15,CONFIG_DDR1_COL_BITS,CONFIG_DDR_BANK_SET,CONFIG_DDR_CHANNEL_SET)) <<12)| \
					((M8_DDR_DTAR_BANK_GET(CONFIG_DDR1_DTAR_ADDR,15,CONFIG_DDR1_COL_BITS,CONFIG_DDR_BANK_SET,CONFIG_DDR_CHANNEL_SET)) << 28));
				__ddr_setting.t_mmc_ddr_ctrl = (__ddr_setting.t_mmc_ddr_ctrl & 0xfffff3f3) | (3<<10) | (3<<2);
				serial_puts("2GB. M8\n");
				break;
			case 0 : /*1G DDR*/
				__ddr_setting.phy_memory_size = 0x40000000;
				__ddr_setting.t_pub0_dtar = ((0x0 + CONFIG_M8_DDR0_DTAR_DTCOL)| \
					((M8_DDR_DTAR_DTROW_GET(CONFIG_DDR0_DTAR_ADDR,14,CONFIG_DDR0_COL_BITS,CONFIG_DDR_BANK_SET,CONFIG_DDR_CHANNEL_SET)) <<12)| \
					((M8_DDR_DTAR_BANK_GET(CONFIG_DDR0_DTAR_ADDR,14,CONFIG_DDR0_COL_BITS,CONFIG_DDR_BANK_SET,CONFIG_DDR_CHANNEL_SET)) << 28));
				__ddr_setting.t_pub1_dtar = ((0x0 + CONFIG_M8_DDR1_DTAR_DTCOL)| \
					((M8_DDR_DTAR_DTROW_GET(CONFIG_DDR1_DTAR_ADDR,14,CONFIG_DDR1_COL_BITS,CONFIG_DDR_BANK_SET,CONFIG_DDR_CHANNEL_SET)) <<12)| \
					((M8_DDR_DTAR_BANK_GET(CONFIG_DDR1_DTAR_ADDR,14,CONFIG_DDR1_COL_BITS,CONFIG_DDR_BANK_SET,CONFIG_DDR_CHANNEL_SET)) << 28));
				__ddr_setting.t_mmc_ddr_ctrl = (__ddr_setting.t_mmc_ddr_ctrl & 0xfffff3f3) | (2<<10) | (2<<2);
				serial_puts("1GB. M8\n");
				break;
			default :
