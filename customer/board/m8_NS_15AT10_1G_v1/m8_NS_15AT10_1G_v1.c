...
struct aml_i2c_platform g_aml_i2c_plat = {
   ...
   .master_b_pinmux = {
        .scl_reg    = MESON_I2C_MASTER_B_GPIOZ_3_REG,
        .scl_bit    = MESON_I2C_MASTER_B_GPIOZ_3_BIT,
        .sda_reg    = MESON_I2C_MASTER_B_GPIOZ_2_REG,
        .sda_bit    = MESON_I2C_MASTER_B_GPIOZ_2_BIT,
    }
};
#endif
...
void wifi_power_init()
{
	...
	clrbits_le32(P_PREG_PAD_GPIO0_EN_N, 0x1<<21);
	clrbits_le32(P_PREG_PAD_GPIO0_O, 0x1<<21);
	clrbits_le32(P_PAD_PULL_UP_REG4, 0x1<<21);
}
