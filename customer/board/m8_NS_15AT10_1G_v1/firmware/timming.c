...
={
	...
	//0x105d [0xc1104174]
	.mpeg_clk_cntl= (6 << 12) |    //[B14,B13,B12] select fclk_div4: 2.55GHz/3=850MHz
    				(1 << 8 ) |    //[B8] select pll
    				(1 << 7 ) |    //[B7] cntl_hi_mpeg_div_en, enable gating
					(5 << 0 ) |    //[B6-B0] div  (n+1)  fclk_div5=2.55G/3=850MHz, clk81=850MHz/(5+1)=141.66MHz
					(1 << 15),     //[B15] Connect clk81 to the PLL divider output

	.vid_pll_cntl = 0x6001043D,
	.vid2_pll_cntl = 0x61000032,
	.clk81=141660000, //2.55GHz/3/5=141.66MHz
