...
//*****************************************
#define MODEL_NAME			"LP097X02_A8370"	/** lcd model name */

#define ACITVE_AREA_WIDTH	194	/** lcd active_area or display_area horizontal size(unit in mm, you can find it on the home page of lcd spec) */
