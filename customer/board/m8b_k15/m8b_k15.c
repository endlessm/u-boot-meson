...
void borad_power_init(void)
{
	...
	gpio_amlogic_requst(NULL, GPIODV_28);
        gpio_amlogic_direction_output(NULL, GPIODV_28, 0);
	//gpio_amlogic_requst(NULL, GPIODV_9);
        //gpio_amlogic_direction_output(NULL, GPIODV_9, 0);
...
void board_dt_id_process(void)
{
	...
	strcat(dt_name, "m8b_k15_");  //please change this name when you add a new config
