...
#define IR_POWER_KEY      0x0003cccf
...
unsigned backup_AO_IR_DEC_BIT_2;
unsigned backup_AO_IR_DEC_BIT_3;
unsigned backup_AO_IR_DEC_BIT_1;
...
void backup_remote_register(void)
{
    ...
    backup_AO_IR_DEC_BIT_1 = readl(P_AO_MF_IR_DEC_STATUS);
    backup_AO_IR_DEC_BIT_2 = readl(P_AO_MF_IR_DEC_DURATN2);
    backup_AO_IR_DEC_BIT_3 = readl(P_AO_MF_IR_DEC_DURATN3);
...
void resume_remote_register(void)
{
    ...
    writel(backup_AO_IR_DEC_BIT_1,P_AO_MF_IR_DEC_STATUS);
    writel(backup_AO_IR_DEC_BIT_2,P_AO_MF_IR_DEC_DURATN2);
    writel(backup_AO_IR_DEC_BIT_3,P_AO_MF_IR_DEC_DURATN3);
...
static int ir_remote_init_32k_mode(void)
{
    ...
    // SCALE LEADER ACTIVE
    writel((readl(P_AO_MF_IR_DEC_LDR_ACTIVE)& ~(0x3FF << 16)) | ((unsigned)(32*1.05) << 16),P_AO_MF_IR_DEC_LDR_ACTIVE);
    writel((readl(P_AO_MF_IR_DEC_LDR_ACTIVE)& ~(0x3FF << 0)) | ((unsigned)(32*0.95) << 0),P_AO_MF_IR_DEC_LDR_ACTIVE);//1008us

    // SCALE LEADER IDLE
    writel((readl(P_AO_MF_IR_DEC_LDR_IDLE)& ~(0x3FF << 16)) | ((unsigned)(18*1.05) << 16),P_AO_MF_IR_DEC_LDR_IDLE);//588
    writel((readl(P_AO_MF_IR_DEC_LDR_IDLE)& ~(0x3FF << 0)) | ((unsigned)(18*0.95) << 0),P_AO_MF_IR_DEC_LDR_IDLE);
	
    writel((readl(P_AO_MF_IR_DEC_BIT_0)& ~(0x3FF << 16)) | ((unsigned)(37*1.05) << 16),P_AO_MF_IR_DEC_BIT_0);//bit 0 =588+588
    writel((readl(P_AO_MF_IR_DEC_BIT_0)& ~(0x3FF << 0))  | ((unsigned)(37*0.95) << 0),P_AO_MF_IR_DEC_BIT_0);//bit 0

    writel((readl(P_AO_MF_IR_DEC_STATUS)& ~(0x3 << 30)),P_AO_IR_DEC_STATUS);
    writel((readl(P_AO_MF_IR_DEC_STATUS)& ~(0x3FF << 20)) | ((unsigned)(47*1.05) << 20),P_AO_IR_DEC_STATUS);//bit 1 588+882
    writel((readl(P_AO_MF_IR_DEC_STATUS)& ~(0x3FF << 10)) | ((unsigned)(47*0.95) << 10),P_AO_IR_DEC_STATUS);//bit 1
	
    writel((readl(P_AO_MF_IR_DEC_DURATN2)& ~(0x3FF << 16)) | ((unsigned)(56*1.05) << 16),P_AO_MF_IR_DEC_DURATN2);//bit 2 588+1176
    writel((readl(P_AO_MF_IR_DEC_DURATN2)& ~(0x3FF)) | ((unsigned)(56*0.95) ),P_AO_MF_IR_DEC_DURATN2);//bit 2
	
    writel((readl(P_AO_MF_IR_DEC_DURATN3)& ~(0x3FF << 16)) | ((unsigned)(66*1.05) << 16),P_AO_MF_IR_DEC_DURATN3);//bit 3 588+1470
    writel((readl(P_AO_MF_IR_DEC_DURATN3)& ~(0x3FF )) | ((unsigned)(66*0.95)),P_AO_MF_IR_DEC_DURATN3);//bit 3
