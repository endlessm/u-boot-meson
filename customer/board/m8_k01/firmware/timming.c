...
STATIC_PREFIX_DATA unsigned char __secureargs_m8[] __attribute__((section(".setting"))) = {
	...
	videoframebufconfig=0x0ca00000,0x109fffff,0x0,0x0,0x0,0x0,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff \0"};
...
STATIC_PREFIX_DATA unsigned char __secureargs_m8m2[] __attribute__((section(".setting"))) = {
	...
	videoframebufconfig=0x0ca00000,0x109FFFFF,0x0,0xff  \0"};
#endif
...
int aml_ddr_pre_init()
{
	...
	board_ver = readl(P_PREG_PAD_GPIO2_I) >> 17 & 0x1;
	serial_puts("\n Board HW Version is ");
