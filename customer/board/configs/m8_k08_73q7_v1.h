#ifndef __CONFIG_M8_K08_73Q7_V1_H__
#define __CONFIG_M8_K08_73Q7_V1_H__

#define CONFIG_SUPPORT_CUSOTMER_BOARD 1
#define CONFIG_AML_MESON_8      1
#define CONFIG_MACH_MESON8_K08_73Q7_V1  // generate M8 K101 machid number
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"charging_or_not="\
		...
		"else if getkey; then "\
			"echo power on; run prepare; bmp display ${poweron_offset}; magic_checkstatus 1; "\
		"else "\
	...
	"custom_delay="\
		...
		"while itest ${msleep_count} < 800; do "\
			"run aconline_or_not; run updatekey_or_not; magic_checkstatus 1; "\
...
#endif //__CONFIG_m8_k08_73q7_V1_H__
