#ifndef __CONFIG_M6_SKYWORTH_M1701_H__
#define __CONFIG_M6_SKYWORTH_M1701_H__
...
//#define CONFIG_MACHID_CHECK 1
	...
	#define CONFIG_MACH_MESON6_CHINACHIP 0x4E2C
...
#define CONFIG_BOOTCOMMAND  "bmp display ${bootup_offset}; secukey nand; secukey read usid; nand read boot ${loadaddr} 0 600000; setenv bootargs ${bootargs} a9_clk_max=1512000000; bootm"
...
//customer/board/m6_skywoth_m1801/firmware/timming.c 

//note: please DO NOT remove following check code
#if !defined(DDR3_9_9_9) && !defined(DDR3_7_7_7)
	#error "Please set DDR3 property first in file m6_skywoth_m1701.h\n"
#endif
...
//note: please DO NOT remove following check code
	...
	#error "Please set DDR3 capacity first in file m6_skywoth_m1701.h\n"
#endif
...
#else
	#error "Please define DDR3 memory capacity in file m6_skywoth_m1701.h\n"
#endif
...
#endif //__CONFIG_M6_SKYWORTH_T069_H
