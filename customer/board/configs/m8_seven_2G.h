#ifndef __CONFIG_m8_seven_2G_H__
#define __CONFIG_m8_seven_2G_H__

#define CONFIG_SUPPORT_CUSOTMER_BOARD 1
#define CONFIG_AML_MESON_8      1
#define CONFIG_MACH_MESON8_SEVEN_V1  // generate M8 K100 machid number
...
#endif //__CONFIG_m8_seven_2G_H__
