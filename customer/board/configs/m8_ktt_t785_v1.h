#ifndef __CONFIG_M8_KTT_T785_V1_H__
#define __CONFIG_M8_KTT_T785_V1_H__

#define CONFIG_SUPPORT_CUSOTMER_BOARD 1
#define CONFIG_AML_MESON_8      1
#define CONFIG_MACH_MESON8_KTT_T785_V1  // generate M8 K101 machid number
