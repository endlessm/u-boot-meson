#ifndef __CONFIG_M8_K05_HP_H__
#define __CONFIG_M8_K05_HP_H__

#define CONFIG_SUPPORT_CUSOTMER_BOARD 1
#define CONFIG_AML_MESON_8      1
#define CONFIG_MACH_MESON8_K05_HP  // generate M8 K105_HP machid number
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"powerkey_or_not="\
		...
		\
	"updatekey_or_not="\
		"if saradc get_in_range 0x40 0x150; then "\
			"msleep 500; " \
			"if getkey; then "\
				"if saradc get_in_range 0x40 0x150; then "\
					"run update; "\
