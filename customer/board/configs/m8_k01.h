#ifndef __CONFIG_M8_K01_V1_H__
#define __CONFIG_M8_K01_V1_H__
...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    \
   	"storeargs="\
        "setenv bootargs init=/init console=${console} no_console_suspend vdaccfg=${vdac_config} storage=${store} logo=osd1,loaded,${fb_addr},${outputmode},full hdmimode=${hdmimode} cvbsmode=${cvbsmode} androidboot.firstboot=${firstboot} hdmitx=${cecconfig}\0"\
    \
	"switch_bootmode="\
...
#define CONFIG_DDR_CLK           768 //696 //768  //792// (636)
