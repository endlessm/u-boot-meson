#ifndef __CONFIG_M8B_K15_V1_H__
#define __CONFIG_M8B_K15_V1_H__

#define CONFIG_SUPPORT_CUSOTMER_BOARD 1
#define CONFIG_MACH_MESON8_K15  // generate M8 K15 machid number
...
#define CFG_DDR_CLK    480 //696 //768  //792// (636)
...
#define CONFIG_LPDDR2_RANK1
#define CONFIG_M8B_DDR_RANK_SET CONFIG_M8B_DDR_RANK0_AND_RANK1
...
//board/amlogic/m8_k15_v1/firmware/timming.c
...
#define PHYS_MEMORY_START        (0x00000000) // ???
	...
	#define CONFIG_DDR3_COL_SIZE (2)
	#define CONFIG_DDR_ROW_BITS  (15)
	#define PHYS_MEMORY_SIZE     (0x80000000) // 1GB
#else
