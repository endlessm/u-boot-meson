...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"preboot="\
        ...
        "run irremote_update; run switch_bootmode\0" \
	...
	"irremote_update=if irdetect ;then run update; fi\0" \
	...
	"nandargs=run cvbscheck; "\
            ...
            "setenv bootargs rootwait init=/init console=ttyS0,115200n8 logo=osd1,0x85100000,${outputtemp},full androidboot.resolution=${outputmode} hdmimode=${hdmimode} cvbsmode=${cvbsmode} hlt vmalloc=256m a9_clk_max=1512000000 vdachwswitch=${vdacswitchmode} hdmitx=${cecconfig}\0"\
	"switch_bootmode="\
	...
	"initargs=rootwait init=/init console=ttyS0,115200n8 nohlt no_console_suspend vmalloc=256m logo=osd1,0x85100000,720p\0" \
