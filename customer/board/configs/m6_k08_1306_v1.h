#ifndef __CONFIG_M6_K08_1306_V1_H__
#define __CONFIG_M6_K08_1306_V1_H__

#define CONFIG_SUPPORT_CUSOTMER_BOARD 1
#define CONFIG_AML_MESON_6 1
#define M6_K08_1306_V1 1
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"updatekey_or_not="\
		"saradc open 4; "\
		"if saradc get_in_range 0x0 0x10; then "\
			"msleep 500; " \
			"if getkey; then "\
				"if saradc get_in_range 0x0 0x10; then "\
					"run update; "\
...
#define CONFIG_BOOTCOMMAND  \
	...
	"setenv bootargs ${bootargs} a9_clk_max=1200000000; "\
...
//note: please DO NOT remove following check code
	...
	#error "Please set DDR3 property first in file m6_k08_1306_v1.h\n"
#endif
...
//note: please DO NOT remove following check code
	...
	#error "Please set DDR3 capacity first in file m6_k08_1306_v1.h\n"
#endif
...
#else
	#error "Please define DDR3 memory capacity in file m6_k08_1306_v1.h\n"
#endif
