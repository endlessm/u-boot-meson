...
//*****************************************
#define MODEL_NAME			"CLAP070NJ02"	/** lcd model name */
...
#define	LCD_CLK				30000000	/** clock(unit in Hz, both support clk and frame_rate, >200 regard as clk, <200 regard as frame_rate) */
#define CLK_POL				0	/** clk_polarity(only valid for TTL) */
#define HS_WIDTH			20	/** hsync_width */
#define HS_BACK_PORCH		160	/** hsync_backporch(include hsync_width) */
